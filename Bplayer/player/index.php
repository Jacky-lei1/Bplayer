...
<head>
    ...
    <meta charset="UTF-8">
    <title>绿野蓬莱岛 - 哔哩播放器</title>
    <link rel="shortcut icon" href="https://cdn.jsdelivr.net/gh/Jacky-lei1/Bplayer/img/5eca62efd083f.png" type="image/x-icon">
    ...
    <style>
        ...
        .yzmplayer-full-icon span {
            background: url(https://cdn.jsdelivr.net/gh/Jacky-lei1/Bplayer/img/5eca627664041.png) center no-repeat;
        }

        .yzmplayer-fulloff-icon span {
            background: url(https://cdn.jsdelivr.net/gh/Jacky-lei1/Bplayer/img/5eca6278b7137.webp) center no-repeat;
        }
